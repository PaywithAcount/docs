...
```html
<script src="/node_modules/acountais/dist/acount.umd.js"></script>
<script>
  const account = new Acount.Account({ clientId: 'your-client-id' });
  console.log('AIS SDK loaded:', typeof Acount.Account === 'function'); // should be true
</script>
```
