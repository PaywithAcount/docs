...
<Info>
  The current WooCommerce plugin uses a single live environment. Use a dedicated test store and low-value orders for integration verification.
</Info>
...
The plugin uses the live AcountPay environment by default. Once your **Client ID** and **API Base URL** are set correctly, your store is ready to accept payments.
