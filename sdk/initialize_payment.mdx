...
| ----------------- | ------------------------------------- | -------- | ------------------------------------------------------------ |
| `amount`          | `number`                              | ✅ Yes    | The payment amount in cents (must be a positive integer)                                  |
...
✅ Setup: Acount SDK initialized with valid clientId
✅ Order Creation: Orders created before payment initiation
✅ Amount Format: Using cents (integers) not decimals
✅ Reference Numbers: Unique identifiers for each transaction 
✅ Success Handling: Business logic in onSuccess callback 
✅ Error Handling: Try-catch blocks with user feedback 
✅ Testing: Test with small amounts in sandbox environment

***

## **Key Takeaways**

✔ Object-based parameters - Pass all parameters as a single object

✔ Async/await pattern - Always use await with initiatePayment

✔ Error handling - Wrap calls in try-catch blocks

✔ Success callback - Handle successful payments in the onSuccess function

The initiatePayment method handles the complete payment flow, from initialization to completion. 🚀
