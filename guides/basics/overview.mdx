...
The AcountPay merchant dashboard helps you streamline payment management and seamlessly integrate our payment solution into your app or e-commerce site. Use it to configure your integration, track transactions, and manage your account. 

**Get started at [merchant.acountpay.com](https://merchant.acountpay.com)**
...
<Accordion title="Onboarding" icon="fa-info-circle">
  **Create Your Account**: Begin by signing up at [merchant.acountpay.com](https://merchant.acountpay.com) using our secure registration process.
...
The dashboard is divided into _four_ key sections: **Transactions**, **Profile**, **Developer** and **Billing**
