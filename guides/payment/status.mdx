---
title: 'Payment Initialization Status'
...
**The following diagrams show the flow between payment initiation statuses**:

The following diagram shows the flow between payment initiation statuses for one-step banks **(one-step banks allow users to authenticate and authorize payments in a single step)** :
