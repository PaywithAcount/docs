...
<Steps>
    ...
    <Step title="Payment Process Overview">
        ...
        This ensures that the payment details are processed safely and efficiently. Once the payment is completed successfully, a confirmation callback is triggered to notify your system.

        To use this method, your account must be properly set up with a valid client ID.
        This ensures that transactions are securely linked to your business and processed without interruptions.
...
<Tip>The entire payment journey is handled within the Checkout Page.</Tip>


<img src="/images/payment_checkout.png" />
