...
1. **Buttons** – Keep your API keys and credentials private; never expose them in client-side code or public repositories.
   ...
   <img
     ...
     style={{ width:"20%" }}
   />
2. **Checkout Page** – Keep your API keys and credentials private; never expose them in client-side code or public repositories.
   ...
   <img
     ...
     style={{ width:"20%" }}
   />
3. **Banner** – Keep your API keys and credentials private; never expose them in client-side code or public repositories.
